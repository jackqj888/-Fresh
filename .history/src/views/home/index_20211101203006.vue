...
<!--                <div class="item-title">Personnel</div>-->
        ...
        <div class="navigationPagination"></div>
      </div>
...
.home-container
  ...
  .healthTreatment
    ...
    .healthTreatment-box
      ...
      .healthTreatment-title
        align-items left

        .healthTreatment-font
          font-size 30px
          font-family PingFang SC
          font-weight bold
