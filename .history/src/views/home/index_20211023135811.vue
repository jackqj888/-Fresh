    ...
    <div class="home-container">
      ...
      <div class="knowledge">
        <div>
          ...
          <p class="e-font">Popular science knowledge solution, your breast management expert</p>
          <p class="go">点击进入 ></p>
        </div>
        <div class="Preview">
          <div class="Preview-left">
            <div>
              <img src="@/assets/cirlces.png" class="Preview1" />
              <span>标题一</span>
              <div class="user">
                 <img src="@/assets/cirlces.png" class="user-image" />
                 <p>汝小果</p>
                 <p>2021-8-5-13 : 19 : 18</p>
              </div>
