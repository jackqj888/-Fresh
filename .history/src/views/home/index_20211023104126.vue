      ...
      <div class="courseCommodity">
        <div class="course">
          ...
          <div class="course-introduction">
            <span class="e-font">
              The examination and training system has launched high-<br>quality courses. I wish you a smooth passing of the<br> examination and training
            </span>
        ...
        <div class="commodity">
          ...
          <div class="commodity-introduction">
            <span class="e-font">
              Shopping mall system shelves recommended<br> goods, value for money, I wish you a happy<br> shopping
            </span>
