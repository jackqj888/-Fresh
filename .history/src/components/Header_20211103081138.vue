        ...
        <div v-else class="userName">
          ...
          <el-dropdown placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown" >
              <el-dropdown-item @click.native="goTo('study')" v-if="appCodes[0].appCode==='kaopei'">我的课程</el-dropdown-item>
              <el-dropdown-item @click.native="goTo('myPage')" v-if="appCodes[2].appCode==='talent'">我的简历</el-dropdown-item>
...
export default {
  props: {
    ...
    created() {
      this.appCodes=this.items.map((item) => {
