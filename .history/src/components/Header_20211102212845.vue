        ...
        <div v-else class="userName">
          ...
          <el-dropdown placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown" >
              <el-dropdown-item @click.native="goTo('study')" v-if="appCode[appCode.length]==='kaopei'">我的课程</el-dropdown-item>
              <el-dropdown-item @click.native="goTo('myPage')" v-if="appCode[appCode.length]==='talent'">我的简历</el-dropdown-item>
    ...
    created() {
      this.items.map(item => {
        if (item.items.appCode === 'kaopei') {
          this.appCode = this.item.items.appCode
