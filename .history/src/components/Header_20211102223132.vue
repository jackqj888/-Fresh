        ...
        <div v-else class="userName">
          ...
          <el-dropdown placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown" >
              <el-dropdown-item @click.native="goTo('study')" v-if="appCode.appCode==='kaopei'">我的课程</el-dropdown-item>
              <el-dropdown-item @click.native="goTo('myPage')" v-if="appCode.appCode==='talent'">我的简历</el-dropdown-item>
